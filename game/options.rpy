...
define config.name = _("О. Генри - Дары волхвов")
...
define gui.about = _p("""О. Генри - Дары волхвов (визуальная новелла)


Текст: О. Генри.

Изображения: ГигаЧат AI.

Музыка: FreeSound.org.

Программирование: Gigabyte-artur@mail.ru.
...
define config.save_directory = "OHenry-1737664526"
